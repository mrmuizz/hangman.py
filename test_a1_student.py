# for running unit tests on comp102 student code
...
if __name__ == '__main__':
    ...
    print("\n\nAssignment 1 Unit Test Results:")
    print(output)
    print("Points for these tests: %s/5\n (Please note that this is not your final a1 score, additional test cases will be run on submissions)" % points)
